...
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'x', 0, 10, 0.001).name('uBigWavesFrequency-X')
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'y', 0, 10, 0.001).name('uBigWavesFrequency-Y')

gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value', 0, 4, 0.001).name('uBigWavesSpeed');
